...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, EmployeeEvent> consumerFactory() {
        ...
        config.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, "net.javaguides.ems.kafka.event");
        config.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE, EmployeeEvent.class.getName());
